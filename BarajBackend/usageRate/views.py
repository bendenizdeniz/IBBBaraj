...
from .serializers import usageRateSerializer

class usageRateList(generics.ListCreateAPIView):
...
'''
class usageRateDetail(generics.RetrieveUpdateDestroyAPIView): 
    queryset = usageRate.objects.all()
    serializer_class = usageRateSerializer
